...
const SPONSORS = [
  ...
  { id: 'papara',     href: 'https://www.papara.com/',                       klass: 'sp-papara',      img: '/logos/papara.png?v=20260620c',             alt: 'Papara' },
  { id: 'nesine',     href: 'https://www.nesine.com/',                       klass: 'sp-nesine',      img: '/logos/nesine.png?v=20260620c',             alt: 'Nesine' },
  { id: 'mastercard', href: 'https://www.mastercard.com.tr/',                klass: 'sp-mastercard',  img: '/logos/mastercard_transparent.png?v=20260620c', alt: 'Mastercard' },
  { id: 'togg',       href: 'https://www.togg.com.tr/',                      klass: 'sp-togg',        img: '/logos/togg.png?v=20260620c',               alt: 'Togg' },
  { id: 'turkcell',   href: 'https://www.turkcell.com.tr/',                  klass: 'sp-turkcell',    img: '/logos/turkcell.png?v=20260620c',           alt: 'Turkcell' },
