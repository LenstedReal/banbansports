    ...
    <section className="main-content">
      <div className="player-layout" id="canli-yayin">
        ...
        >
          ...
          {/* ⚡ FPS GÖSTERGESİ — sağ-üst rozetle BİREBİR aynı tasarım (.video-fps-counter),
              tek kaynaktan (displayFps) okur. UNMUTE pill açıkken solunda durur. */}
          {hasStarted && !adActive && !awaitingResume && !streamError && isPlaying && displayFps > 0 && (
            <div
              data-testid="fps-indicator"
              className={`video-fps-counter ${fpsClass(displayFps)}`}
              style={{ right: muted ? 110 : 10, top: 10 }}
            >
              <span>{displayFps}</span><small>FPS</small>
            </div>
          )}
            ...
            <div className="overlay maintenance-overlay" data-testid="stream-error">
              {maintLoop ? (
                <>
                  ...
                  />
                  {/* CRT bozuk TV efekti — döngünün üzerinde */}
                  <div className="maint-crt" aria-hidden="true" />
                  {/* Bakım uyarısı — bozuk TV döngüsünün ÜZERİNDE */}
                  <div className="maint-warn" data-testid="maintenance-warn">
                  ...
                  {subtitleOpen && (
                    <div
                      ...
                      style={{
                        ...
                        background: 'linear-gradient(180deg, rgba(16,8,26,0.96), rgba(8,4,14,0.97))',
                        border: '1px solid rgba(0,240,255,0.65)',
                        borderRadius: 8, overflow: 'hidden',
                        minWidth: 140, padding: '6px 0',
                        boxShadow: '0 10px 28px rgba(0,0,0,0.6), 0 0 16px rgba(0,240,255,0.22)',
                    ...
                    >
                      <div
                        ...
                        style={{
                          padding: '9px 16px', fontSize: 12, cursor: 'pointer', transition: 'background-color .15s ease, color .15s ease',
                  ...
                  {qualityOpen && (
                      <div
                        ...
                        style={{
                          ...
                          background: 'linear-gradient(180deg, rgba(16,8,26,0.96), rgba(8,4,14,0.97))',
                          border: '1px solid rgba(255,0,170,0.65)',
                          borderRadius: 8, overflow: 'hidden',
                          minWidth: 140, padding: '6px 0',
                          boxShadow: '0 10px 28px rgba(0,0,0,0.6), 0 0 16px rgba(255,0,170,0.25)',
                          backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)',
                          pointerEvents: 'auto',
                          zIndex: 50,
                        }}
